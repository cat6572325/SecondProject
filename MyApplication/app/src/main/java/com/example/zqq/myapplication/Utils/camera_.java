...
public class camera_ extends Activity  implements SurfaceHolder.Callback {
...
Player_ mPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler();
       // tvTime = (TextView) findViewById(R.id.timertop);
      //  tvSize=(TextView)findViewById(R.id.tv_video_size);
        btnStop = (Button) findViewById(R.id.Round_flash);
        btnStart = (Button) findViewById(R.id.start_round);
